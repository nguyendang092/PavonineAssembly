...
const PAYROLL_WIDTHS_FULL_NO_ACTIONS = [
  2, 6, 5, 18, 5, 8, 7, 5, 9, 5, 5, 6, 5, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4,
];

/** Trọng số cột hành động (Sửa) — nối sau PAYROLL_*_NO_ACTIONS khi `showRowModalActions`. */
const PAYROLL_WIDTH_ACTIONS = 2;

/* compact */
const PAYROLL_WIDTHS_COMPACT_NO_ACTIONS = [
  7, 10, 8, 18, 6, 18, 11, 5, 8, 5, 5, 5, 4, 4, 4, 4, 4, 5, 5, 5, 5, 8,
];

/* narrow (+ cột lễ) */
const PAYROLL_WIDTHS_NARROW_NO_ACTIONS = [
  8, 11, 9, 22, 7, 5, 9, 5, 6, 5, 5, 5, 4, 4, 4, 4, 5, 5, 4, 11, 4,
];

/* minimal */
const PAYROLL_WIDTHS_MINIMAL_NO_ACTIONS = [
