...
export const PAYROLL_WIDTHS_FULL_NO_ACTIONS = [
  2, 6, 5, 14, 5, 8, 5, 5, 10, 5, 5, 5, 6, 5, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4,
];
...
export const PAYROLL_WIDTHS_COMPACT_NO_ACTIONS = [
  7, 10, 8, 15, 6, 18, 5, 11, 5, 8, 5, 5, 5, 4, 4, 4, 4, 4, 5, 5, 5, 5, 9,
];

/* narrow (+ cột lễ) */
export const PAYROLL_WIDTHS_NARROW_NO_ACTIONS = [
  8, 11, 9, 19, 7, 5, 13, 9, 5, 6, 5, 5, 5, 4, 4, 4, 4, 5, 5, 4, 12, 4,
];

/* minimal */
export const PAYROLL_WIDTHS_MINIMAL_NO_ACTIONS = [
  18, 16, 12, 11, 10, 8, 6, 5, 5, 5, 6, 5, 6, 5, 6, 13, 5,
];
