        ...
        {canManageOffDays ? (
          ...
          >
            <button
              ...
              className={`inline-flex h-8 w-full min-w-0 cursor-pointer items-center gap-2 overflow-hidden rounded-lg border-2 px-3 text-sm font-bold tracking-tight shadow-md outline-none transition-all sm:px-3 sm:max-w-[min(100vw-10rem,19rem)] ${
                offHolidayDropdownOpen
                  ? "border-violet-500 bg-gradient-to-r from-violet-600 to-indigo-600 text-white shadow-lg shadow-violet-600/35"
