...
export default function AttendanceEmployeeFormModal({
  ...
  const showDriverOtMinutesField =
    employeeRegimeSelectValue === EMPLOYEE_REGIME.TAIXE ||
    employeeRegimeSelectValue === EMPLOYEE_REGIME.TAIXETONG;
      ...
      if (editAttendanceKey) {
        ...
        const dayDoc = buildEmployeeAttendanceDayDocument({
          form: (() => {
            ...
            delete slice[ATTENDANCE_EMP.ANNUAL_LEAVE_IMAGE_URL];
            delete slice[ATTENDANCE_EMP.OT_PAPERWORK_IMAGE_URL];
            if (!allowFullEdit) {
