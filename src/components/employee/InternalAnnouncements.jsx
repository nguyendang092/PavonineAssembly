...
function AnnouncementBody({ body, className }) {
  ...
  if (isHtmlContent(raw)) {
    return (
      <div
        className={
          className ||
          "text-sm leading-relaxed text-slate-800 [&_a]:text-sky-600 [&_img]:max-h-96 [&_img]:max-w-full [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5"
        }
    ...
    <div className="flex min-h-screen w-full flex-col bg-[#f5f5f5] text-slate-800 dark:bg-slate-950 dark:text-slate-200 lg:flex-row">
      ...
      <div className="flex min-h-0 min-w-0 flex-1 flex-col">
        ...
        <div className="flex min-h-0 flex-1 flex-col lg:flex-row">
          {/* List column */}
          <div
            className={`min-h-[50vh] min-w-0 flex-1 overflow-y-auto bg-white dark:bg-slate-900 lg:min-h-0 ${
          ...
          {!isNarrow && (
            <div className="hidden w-full max-w-xl flex-shrink-0 border-l border-slate-200 bg-white dark:border-slate-700 dark:bg-slate-900 lg:flex lg:flex-col">
              {selected ? (
                <>
