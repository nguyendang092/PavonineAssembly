const ko = {
  ...
  attendanceList: {
    ...
    employmentStatusProbation: "수습",
    employmentStatusResigned: "퇴사",
    employmentStatusMaternity: "출산 휴가",
    employmentStatusSuspended: "휴직",
    employmentStatusValue_dang_lam: "정규직",
    employmentStatusValue_thu_viec: "수습",
    employmentStatusValue_tam_nghi: "휴직",
    employmentStatusValue_thai_san: "출산 휴가",
    employmentStatusValue_nghi_viec: "퇴사",
    annualLeave: "연차",
    mvt: "지문 ID",
    mnv: "사원번호",
    stt: "순번",
