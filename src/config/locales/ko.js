...
const ko = {
  ...
  s90dReport: {
    ...
    monthFilter: "월",
    monthYearFilter: "월/년",
    dailySectionTitle: "일별 표",
    dailySectionHint: "이번 달 {{count}}일 (1일~오늘)",
    totalSectionTitle: "종합 표 (TOTAL)",
    processDetailSectionTitle: "공정별 시간대 상세",
    processDailySectionTitle: "일별 상세",
    processWeekHint: "{{week}} 주차",
    processDailyEditHint:
      "시간대별 OK, NG, 상품 코드, 불량 항목을 입력하세요. 총수량=OK 수량; 일별·종합 탭 자동 갱신.",
    dailyAutoHint: "공정 탭에 입력한 데이터를 자동 집계합니다",
    totalFromDailyHint: "일별 탭 데이터 전체 합계 ({{month}})",
    manualEntryHint:
      "데이터가 없습니다. PRESS, HAIRLINE, ANODIZING, ASSEMBLY 탭에서 일별 수량을 입력하세요.",
    firebaseManualPath:
      "Firebase (S90D 불량 사진): {{path}} — attendance(연차/연장)와 분리",
    ...
    processNextDay: "다음 날",
    unsavedChangesHint:
      "저장되지 않은 변경 — 저장하면 일별·종합 탭에 반영됩니다.",
    boardTitle: "생산 품질 추적표",
    boardSubtitle: "시간대별 수량·수율·불량 추적",
    ...
    kpiNgHint: "NG",
    kpiNgRate: "불량율",
    kpiNgRateHint: "총수량 대비",
    defectUploadImage: "사진",
    defectViewImage: "보기",
    defectViewImageN: "보기 {{n}}",
    defectRemoveImage: "사진 삭제",
    ...
    chartTotalSubtitle: "공정별 OK/NG 수량 및 수율 비교",
    ...
    chartProcessQtyHint: "월간 공정별 OK/NG 및 수율 비교",
    chartDailyQtyHint: "녹색=OK · 빨강=NG · 파란선=수율(%)",
  ...
  ap5Report: {
    ...
    chartReportBadgeAp5fl: "AP5FL 보고",
  },
  workplaceChart: {
    menuTitle: "📁 메뉴",
    chooseExceltotal: "총합",
