...
const ko = {
  ...
  attendanceList: {
    ...
    sidebarDailyReport: "일일 출석 보고서",
    sidebarPersonnel: "인사",
    dashboardReportTitle: "직원 출석 통계 보고서",
    dashboardCompanyName: "PAVONINE VINA 유한회사",
    ...
    dashboardPeriodDay: "일",
    dailyReportTitle: "일일 출석 보고서",
    dailyReportDashboardTitle: "생산 인사 출석",
    dailyReportDashboardSubtitle: "생산 부서 일일 출석 통계",
    dailyReportPendingShort: "미출석",
    dailyReportMetricsAria: "출석 요약",
    dailyReportMetricsTotalHeadcount: "총 인원",
    ...
    dailyReportMetricsHeadcountDetail: "정규직 {{regular}} · 일용직 {{seasonal}}",
    dailyReportMetricsPresentDetail: "주간 {{day}} · 야간 {{night}}",
    dailyReportMetricsAbsenceDetail:
      "결근/연차 {{absent}} · 미출석 {{pending}}",
    dailyReportDownloadImage: "이미지 저장",
    dailyReportExportExcel: "Excel 내보내기",
    dailyReportImageExporting: "저장 중…",
    dailyReportExcelExporting: "내보내는 중…",
    dailyReportImageExportError: "보고서 이미지를 저장할 수 없습니다.",
    dailyReportExcelExportError: "Excel을 내보낼 수 없습니다.",
    dailyReportSubtitle:
      "공정별 출석 통계 — 주간/야간, 정규직/일용직.",
    dailyReportDateLabel: "날짜",
    dailyReportProcess: "공정",
    dailyReportCategory: "구분",
    dailyReportDayShift: "주간 근무",
    dailyReportNightShift: "야간 근무",
    dailyReportHeadcount: "인원",
    dailyReportAbsence: "결근 연차",
    dailyReportPresent: "출근 인원",
    dailyReportAbsenceRate: "결근율",
      dailyReportRemarks: "비고",
      dailyReportPendingAttendance: "미출석",
      dailyReportRegularWorker: "정규직",
    dailyReportDailyWorker: "일용직",
    dailyReportTotal: "TOTAL",
    dailyReportGrandTotal: "TOTAL",
    dailyReportLoading: "보고서 로딩 중…",
    dailyReportError: "데이터를 불러올 수 없습니다: {{error}}",
    offDayBadge: "휴무",
    holidayDayBadge: "공휴",
    compensatoryDayBadge: "대체휴무",
    dashboardPeriodWeek: "주",
    dashboardPeriodMonth: "월",
    dashboardPeriodYear: "년",
    ...
    dashboardLoading: "데이터 로딩 중…",
    dashboardOffDaysInPeriod: "휴무일 {{count}}일",
    dashboardHolidaysInPeriod: "공휴일 {{count}}일",
    dashboardDeptFilter: "부서",
    dashboardDeptAll: "전체 부서",
    dashboardStandardTime: "기준 시간",
    dashboardOffDay: "휴무일",
    dashboardHoliday: "공휴일",
    dashboardExportExcel: "엑셀보내기",
    dashboardPrint: "인쇄",
    dashboardKpiTotal: "총 인원",
    ...
    dashboardWeekTrend: "주간 추이",
    dashboardMonthTrend: "월간 주별 추이",
    dashboardYearTrend: "연간 월별 추이",
    dashboardWeekLoading: "추이 로딩 중…",
    dashboardAbsentList: "무단 결근",
    dashboardColName: "성명",
    dashboardColDept: "부서",
    dashboardColMnv: "사원번호",
    dashboardColLeaveType: "휴가 유형",
    dashboardColTimeIn: "출근 시간",
    dashboardDeptStructure: "부서별 인원",
    dashboardDeptResignationRate: "부서별 퇴사 비율",
    dashboardResignationRate: "퇴사 비율",
    ...
    dashboardSeniorityLt3m: "3개월 미만",
    dashboardSeniority3_6m: "3–6개월",
    dashboardSeniority6m_1y: "6개월–1년",
    dashboardSeniority1_3: "1–3년",
    dashboardSeniority3_5: "3–5년",
    dashboardSeniority5_10: "5–10년",
    dashboardSeniorityGt10: "10년 초과",
    ...
    annualLeaveImageUpload: "연차 증빙 사진",
    otPaperworkImageUpload: "연장근무 서류",
    imgbbChooseImage: "사진 선택",
    imgbbUploading: "업로드 중…",
    imgbbViewImage: "사진 보기",
    imgbbRemoveImage: "삭제",
    imgbbNoImage: "사진 없음",
    imgbbMissingApiKey:
