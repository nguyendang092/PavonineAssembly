...
const vi = {
  ...
  s90dReport: {
    ...
    pageSubtitle: "Nhập số liệu ở tab công đoạn",
    tabsLabel: "Loại báo cáo S90D",
    tabDaily: "Theo ngày",
    tabTotal: "Tổng",
    weekFilter: "Tuần",
    noWeekData: "Chưa có tuần",
    reload: "Tải lại",
    ...
    dailySectionTitle: "Bảng theo ngày",
    dailySectionHint: "{{count}} ngày (đầu tháng → hôm nay)",
    totalSectionTitle: "Bảng tổng hợp (TOTAL)",
    processDetailSectionTitle: "Chi tiết bộ phận theo ca",
    processDailySectionTitle: "Chi tiết theo ngày",
    processWeekHint: "Tuần {{week}}",
    processDailyEditHint:
      "Nhập OK, NG, mã hàng và các ô lỗi theo ca. Tổng số lượng = số lượng OK; tab Theo ngày và Tổng tự cập nhật.",
    totalFromDailyHint:
      "Tổng hợp toàn bộ số liệu đã nhập ở tab Theo ngày ({{month}})",
    manualEntryHint:
      "Chưa có số liệu. Mở tab PRESS, HAIRLINE, ANODIZING hoặc ASSEMBLY để nhập số lượng theo ngày.",
    firebaseManualPath:
      "Firebase (ảnh lỗi S90D): {{path}} — tách khỏi attendance (phép năm / giấy tăng ca)",
    ...
    processSaveHint:
      "Nhập xong bấm Lưu — dữ liệu chỉ ghi Firebase khi bạn bấm nút này.",
    processDateFilter: "Chọn ngày",
    processPrevDay: "Ngày trước",
    processNextDay: "Ngày sau",
    unsavedChangesHint:
      "Có thay đổi chưa lưu — bấm Lưu để ghi Firebase và cập nhật tab Theo ngày / Tổng.",
    boardTitle: "Bảng sản lượng S90D",
    boardSubtitle:
      "Theo dõi số lượng, hiệu suất và lỗi theo khung giờ sản xuất",
    dailyBoardTitle: "Bảng sản lượng S90D theo ngày",
    totalBoardTitle: "Bảng sản lượng S90D",
    metaDate: "Ngày",
    metaMonthYear: "Tháng/Năm",
    metaProductCode: "Mã hàng",
    metaProcess: "Công đoạn",
    metaScope: "Phạm vi",
    scopeDaily: "Theo ngày",
    scopeMonth: "Cả tháng",
    ...
    kpiNgRate: "Tỷ lệ NG",
    defectUploadImage: "Ảnh",
    defectViewImage: "Xem",
    defectViewImageN: "Xem {{n}}",
    defectRemoveImage: "Xóa ảnh",
