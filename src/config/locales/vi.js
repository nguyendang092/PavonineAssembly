const vi = {
  ...
  navbar: {
    ...
    employeeRoster: "Danh sách nhân viên",
    employeeRosterResigned: "Nhân viên nghỉ việc",
    attendanceDashboard: "Thống kê điểm danh",
  ...
  attendanceDashboard: {
    pleaseLogin: "Vui lòng đăng nhập để xem dashboard",
    title: "📊 Dashboard Báo Cáo Điểm Danh",
    subtitle: "Tổng quan thống kê chấm công theo ngày",
    dateLabel: "Ngày:",
    filterAll: "Tổng tất cả",
    filterProduction: "Sản xuất",
    cardTotalLabel: "Tổng số",
    cardTotalFooter: "Tổng nhân viên hôm nay",
    cardPresentLabel: "Có mặt",
    cardPresentFooter: "Đã điểm danh",
    cardAbsentLabel: "Vắng mặt",
    cardAbsentFooter: "Chưa điểm danh",
    cardRateLabel: "Tỷ lệ",
    genderSection: "👫 Thống kê theo giới tính",
    genderTotal: "Tổng: {{n}}",
    male: "Nam",
    female: "Nữ",
    shiftSection: "🕐 Thống kê theo ca làm việc",
    shifts: "{{n}} ca",
    people: "{{count}} người",
  },
  attendanceTable: {
  ...
  driverLogbook: {
    ...
    sectionTitle: "Chuyên Mục",
    navSchedule: "DANH SÁCH CHUYẾN ĐI",
    navTrips: "CHI TIẾT CHUYẾN ĐI",
    navExpenses: "CHI PHÍ NGOÀI",
    navAddTrip: "THÊM CHUYẾN MỚI",
    navDrivers: "QUẢN LÝ TÀI XẾ",
    tipTitle: "Mẹo",
    tipDesc: "Sử dụng bộ lọc để tìm chuyến đi nhanh hơn",
    close: "Đóng",
    scheduleTitle: "LỊCH CHUYẾN ĐI",
    sortTime: "Giờ",
    sortVehicle: "Xe",
    ...
    headerFrom: "ĐI TỪ",
    headerDriver: "TÀI XẾ",
    headerStartTime: "THỜI GIAN ĐI",
    headerDepartment: "BP",
    headerRequester: "YÊU CẦU",
    headerStatus: "TT",
    headerNotes: "GHI CHÚ",
    headerDetails: "CHI TIẾT",
    noTrips: "Không có chuyến đi nào",
    noTripsHint: "Chọn ngày hoặc xe khác để xem lịch",
    tabOngoing: "Chạy",
    tabCompleted: "Xong",
    chooseDateToFilter: "Chọn ngày để lọc chuyến đi",
    clearDateFilter: "Xóa bộ lọc ngày",
    downloadTemplate: "Tải file mẫu Excel",
    importExcel: "Nhập chuyến đi từ Excel",
    upload: "Upload",
    exportCompleted: "Xuất chuyến đã hoàn tất",
    export: "Xuất",
    noRunningTrips: "Không có chuyến đi đang chạy",
    noCompletedTrips: "Chưa có chuyến đi nào hoàn tất",
    noTripsYet: "Chưa có chuyến đi nào",
    statusScheduled: "Đã Lên Lịch",
    statusOnboard: "Đi công tác",
    statusArrived: "Đang ở công ty",
    statusDelayed: "Chậm",
    importSuccess: "✅ Đã nhập {{count}} chuyến từ Excel",
    importSuccessWithSkipped:
      "✅ Đã nhập {{count}} chuyến từ Excel (bỏ qua {{skipped}} dòng thiếu dữ liệu/trùng)",
    importError: "❌ Lỗi nhập Excel: {{error}}",
  },
  missingEmployees: {
  ...
  maintenanceHistory: {
    ...
    noAccessDesc: "Chỉ có quản trị viên mới có quyền xem lịch sử.",
    title: "📋 Lịch Sử Quản lý Tổng Vụ (GA)",
    filterAll: "Tất cả ({{count}})",
    filterAdd: "➕ Thêm mới",
    filterEdit: "✏️ Cập nhật",
    filterDelete: "🗑️ Xóa",
    searchPlaceholder: "🔍 Tìm kiếm theo tên công việc, người thực hiện...",
    noHistory: "Chưa có lịch sử nào",
    noResults: "Không tìm thấy lịch sử phù hợp",
    performedBy: "👤 Thực hiện bởi:",
    details: "📝 Chi tiết:",
    idLabel: "ID:",
    footerCount: "Hiển thị {{shown}} / {{total}} bản ghi",
    close: "Đóng",
    actionAdd: "Thêm mới",
    actionEdit: "Cập nhật",
    actionDelete: "Xóa",
    actionUnknown: "Thao tác",
    unknown: "Không rõ",
  },
};
