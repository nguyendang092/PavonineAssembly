const vi = {
  ...
  performanceChart: {
    ...
    statusGood: "Đạt tốt",
    statusWarn: "Cần đẩy mạnh",
    statusBad: "Nguy cấp",
    kpiSection: "Chỉ số tổng quan",
    kpiAvgAchievement: "Tỷ lệ đạt TB",
    kpiAvgHint: "{{count}} team",
    kpiGoodTeams: "Team đạt tốt",
    kpiGoodTeamsHint: "/ {{total}} team ≥ 100%",
    kpiCumulative: "Lũy kế / Mục tiêu",
    kpiCumulativeHint: "Mục tiêu {{target}}",
    kpiWeekOutput: "Tuần W{{week}}",
    kpiWeekHint: "Tổng sản lượng tuần gần nhất",
    colTeam: "Team",
    colTarget: "Mục tiêu",
  ...
  navbar: {
    ...
    inventoryAudit: "Bảng kiểm toán tồn kho",
    mc: "MC",
  ...
  navigationBoard: {
    ...
    descInventoryAudit:
      "Bảng kiểm toán tồn kho theo vị trí, mã ERP và số lượng thực tế.",
  ...
  inventoryAudit: {
    pageTitle: "Kiểm kê tồn kho",
    pageSubtitle: "Không gian riêng cho từng người.",
    workspaceOf: "{{name}}",
    workspaceViewing: "{{name}}",
    workspaceSelect: "Không gian",
    workspaceMine: "Của tôi",
    workspaceGroupMine: "Của tôi",
    workspaceGroupOthers: "Người khác",
    workspaceViewOnlyBadge: "Chỉ xem",
    workspaceViewOnlyWarn: "Chỉ xem",
    workspaceViewOnlyHint: "Không sửa được",
    workspaceSearch: "Tìm không gian…",
    workspaceEmptyList: "Chưa có không gian.",
    workspaceAdd: "Tạo mới",
    mergeBtn: "Gộp dữ liệu",
    mergeFrom: "Bảng 1",
    mergeWith: "Bảng 2",
    mergeInto: "Lưu vào",
    mergeIntoNew: "Không gian mới",
    mergePick: "Chọn bảng…",
    mergeRun: "Gộp",
    mergeConfirm: "Gộp «{{a}}» và «{{b}}»? Hai bảng gốc giữ nguyên.",
    mergeNewTitle: "{{a}} + {{b}}",
    workspaceAddPrompt: "Tên không gian",
    workspaceAddDefaultName: "Không gian {{n}}",
    workspaceDefault: "Chính",
    workspaceUntitled: "Chưa đặt tên",
    workspaceTitleLabel: "Tên",
    workspaceTitlePlaceholder: "Đặt tên không gian…",
    workspaceRename: "Đổi tên",
    workspaceRenamePrompt: "Đổi tên",
    workspaceDelete: "Xóa bảng",
    workspaceDeleteConfirm: "Xóa không gian này và mọi dòng trong đó?",
    sourceTitle: "Dữ liệu nguồn",
    sourceUploadBtn: "Tải nguồn",
    sourceUploading: "Đang tải…",
    sourceClearBtn: "Gỡ nguồn",
    sourceClearConfirm: "Gỡ file nguồn dùng chung?",
    sourceEmptyState: "Chưa có nguồn.",
    sourceEmpty: "File nguồn trống.",
    sourceTooLarge: "File quá lớn. Giảm cột hoặc chia file.",
    sourceUploadedBy: "{{email}}",
    sourceUploadedAt: "{{when}}",
    sourceLoadError: "Không tải được nguồn.",
    sourceSaveError: "Không lưu được nguồn.",
    addRow: "Thêm dòng",
    addRowOne: "Thêm 1 dòng",
    addRowMany: "Nhập số dòng…",
    addRowManyPrompt: "Số dòng cần thêm (1–500)",
    addRowMenu: "Tùy chọn thêm dòng",
    uploadBtn: "Nhập Excel",
    exportBtn: "Xuất Excel",
    exporting: "Đang xuất…",
    exportError: "Không xuất được Excel.",
    clearBtn: "Xóa hết",
    clearConfirm: "Xóa toàn bộ dòng trong không gian này?",
    deleteRow: "Xóa dòng",
    loading: "Đang tải…",
    saving: "Đang lưu",
    savedOwn: "Đã lưu",
    savedPrivate: "Riêng",
    viewOnlyHint: "Chỉ xem",
    saveError: "Không lưu được.",
    loadError: "Không tải được bảng.",
    loadErrorOthers: "Không tải được danh sách.",
    emptyHint: "Chưa có dòng. Bấm Thêm dòng để bắt đầu.",
    emptyView: "Bảng này trống.",
    searchPlaceholder: "Tìm tag, vị trí, code…",
    rowCount: "{{count}} dòng",
    qtyTotal: "Tổng SL {{qty}}",
    qtyTotalLabel: "Tổng",
    errorMissingColumns: "Thiếu cột Location / ERP / Item.",
    errorEmpty: "Sheet trống.",
    errorParse: "Không đọc được file .xlsx.",
  },
  warehouseDashboard: {
