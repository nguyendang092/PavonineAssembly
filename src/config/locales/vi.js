...
const vi = {
  ...
  annualLeave: {
    ...
    balanceRemaining: "Khả dụng còn lại",
    halfAnnualLeaveApproved: "Đã được phê duyệt",
    totalUsed: "Tổng đã dùng",
    totalUsedYear: "Tổng cộng năm {{year}}",
    ...
    recalculate: "Tính lại từ điểm danh",
    ...
    workHoursMonthHeading: "{{month}}/{{year}}",
